...
pub extern fn gzseek(gzFile, off_t, c_int) off_t;
pub extern fn gztell(gzFile) off_t;
pub extern fn gzoffset(gzFile) off_t;
pub extern fn adler32_combine(uLong, uLong, off_t) uLong;
pub extern fn crc32_combine(uLong, uLong, off_t) uLong;
pub extern fn crc32_combine_gen(off_t) uLong;
...
pub extern fn gzvprintf(file: gzFile, format: [*c]const u8, va: [*c]struct___va_list_tag_2) c_int;
...
pub const ZEXTERN = @compileError("unable to translate C expr: unexpected token 'extern'");
// /usr/include/zconf.h:379:11
pub const ZEXPORT = "";
pub const ZEXPORTVA = "";
pub const FAR = "";
...
pub const z_off_t = off_t;
pub const Z_LFS64 = "";
pub const z_off64_t = z_off_t;
pub const ZLIB_VERSION = "1.3.1";
pub const ZLIB_VERNUM = @as(c_int, 0x1310);
pub const ZLIB_VER_MAJOR = @as(c_int, 1);
pub const ZLIB_VER_MINOR = @as(c_int, 3);
pub const ZLIB_VER_REVISION = @as(c_int, 1);
